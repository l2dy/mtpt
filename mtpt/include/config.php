...
$delaycardcheck = $MAIN['delaycardcheck'];
$edureg = $MAIN['edureg'];
...
$onegbdownload_bonus = $BONUS['onegbdownload'];
$fivegbdownload_bonus = $BONUS['fivegbdownload'];
$tengbdownload_bonus = $BONUS['tengbdownload'];
