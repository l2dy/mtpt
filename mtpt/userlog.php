...
function searchtable($title, $action, $opts = array()){
		...
		print("<input type=\"text\" name=\"query\" style=\"width:200px\" value=\"".RemoveXSS($_GET['query'])."\">\n");
		print("<input type=\"hidden\" name=\"action\" value='".$action."'>&nbsp;&nbsp;");
		print("<input type=submit value=" . $lang_log['submit_search'] . ">&nbsp;&nbsp;有疑问请发送邮件至mtpt@nwsuaf.edu.cn</form>\n");
