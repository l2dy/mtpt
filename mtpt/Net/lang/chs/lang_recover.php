...
(
	...
	'text_use_form_below' => "使用以下表格重置密码，更新后的帐户信息会发送到你的邮箱。<br/><span style='color:red' >如未收到邮件可能是因为某些邮件运营商用力过猛，请检查您的垃圾箱。<br/>如果学校网络出现故障，则可能导致邮件发送失败。邮件将在网络恢复之后自动发送。<br/><a  target=_blank style='color:blue' href='http://nic.nwsuaf.edu.cn/tzgg/index.htm'>西北农林科技大学网络与教育中心-通知公告</a>",
