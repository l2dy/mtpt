	...
	else
	{
		...
		switch ($type)
		{
			...
			case 'image':
				...
				$code = "<a href=\"adredir.php?id=".$adid."&amp;url=".rawurlencode(htmlspecialchars($_POST['ad']['image']['link']))."\" target=\"_blank\ class=\"faqlink\"><img border=\"0\" src=\"".htmlspecialchars($_POST['ad']['image']['url'])."\"".$imgadd." alt=\"aa\" /></a>";
				break;
			case 'flash':
